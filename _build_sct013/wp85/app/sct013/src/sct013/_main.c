...
// Startup code for the executable 'sct013'.
...
LE_SHARED const char* _sct013Component_le_adc_ServiceInstanceName = "sct013.sct013Component.le_adc";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t sct013_exe_LogSession;
LE_SHARED le_log_Level_t* sct013_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    sct013_exe_LogSession = log_RegComponent("sct013_exe", &sct013_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_sct013Component.so");
